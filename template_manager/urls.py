from .views import all_templates, generate_template, template_details, edit_template, \
template_education, template_empl_history, template_languages, template_personal_info, template_skills
