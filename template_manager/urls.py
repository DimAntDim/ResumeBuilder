...
template_education, template_empl_history, template_languages, template_personal_info, template_remove_education, template_remove_empl_history, template_remove_skill, template_skills
...
urlpatterns = [
     ...
     path('edit/employment-history/<int:pk>', template_remove_empl_history, name='template remove empl history'),
